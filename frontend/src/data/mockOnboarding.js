...
export const INTEREST_KEYWORD_GROUPS = [
  {
    category: '제품·기술',
    keywords: [
      // 맨토님 관심 키워드(2026-08-09 피드백) 중 자사명이라 '경쟁사' 그룹에는 안 맞는
      // 'SK하이닉스'를 여기 맨 앞에 둔다 — scripts/register_sources.py의 수집 쿼리에는
      // 이미 있지만, 사용자가 직접 고르는 관심 키워드 목록에는 옵션 자체가 없었다.
      'SK하이닉스',
  ...
  },
  {
    category: '시장·경영',
    keywords: [
      // '반도체 가격'과 별개로 맨토님이 직접 짚은 '메모리 가격'을 리터럴 옵션으로 추가.
      '반도체 가격', '메모리 가격', '시장 규모', '실적', '매출', '영업이익', '수익성', '적자', '흑자', '전망',
...
export const ROLE_OPTIONS = [
  '전략·기획', '마케팅', '개발·엔지니어링',
  '영업·구매', '경영지원', '학생·취준',
  // 반도체 산업 실무 직무 — 위 일반 직군만으로는 반도체 업계 종사자가 자신에게
  // 맞는 항목을 못 찾는다는 피드백으로 추가.
  '반도체 공정', '반도체 공정기술', '반도체 소자', '반도체 설계', '반도체 회로설계',
  '반도체 품질관리', '반도체 장비', '반도체 장비기술', '반도체 소재', '반도체 패키징',
  '테스트/검사', '생산기술', '제조기술', '연구개발(R&D)', '공정개발',
  '제품개발', '기술영업', '품질/분석', '생산관리',
];
