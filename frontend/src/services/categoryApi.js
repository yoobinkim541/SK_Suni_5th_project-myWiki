...
// 백로그가 줄면서 해소됐습니다. 그래도 빈 문자열이 올 수 있으니 화면은 빈 값을 견뎌야 합니다
// (백엔드가 근거 없는 인용문을 만들어 채우지 않습니다).
//
// ⚠ 카테고리 카드의 level(낮음/보통/높음)은 최근 7일 **발행분**의 신뢰도 평균입니다.
//   집계 기준이 분석 시각에서 발행 시각으로 바뀌었습니다(백엔드 #268). 일일 리포트의
//   24시간 창과는 다른 기준이라, 같은 날짜라도 두 화면의 건수가 다를 수 있습니다.
//
