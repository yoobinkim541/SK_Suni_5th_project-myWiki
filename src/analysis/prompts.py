...
고객·수요산업:
NVIDIA, AMD, Apple, 빅테크, 데이터센터, AI 서버, 스마트폰, 자동차 등 고객 기업과 최종 수요 산업의 수요 변화가 핵심인 기사

공급망·생산:
공장, 생산능력, 팹 증설, 장비, 소재, 물류, 재고, 공급 부족, 생산 중단 및 공급망 재편이 핵심인 기사

정책·규제:
정부 정책, 법률, 보조금, 세제, 관세, 수출 통제, 국가 간 산업 정책과 규제가 핵심인 기사

시장·경영:
반도체 가격, 시장 규모, 실적, 매출, 영업이익, 투자, 인수합병, 조직, 경영전략 및 산업 전망이 핵심인 기사
